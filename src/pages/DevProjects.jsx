...
const DevProjects = () => {
  return (
    <>
      <div
        className={`bg-[#000000] text-white font-proxima flex justify-center items-center h-auto`}
      >
        <div className={styles.content}>
          <div className="w-[700px] h-[450px] rounded-lg bg-[#141414] overflow-hidden flex flex-col mb-10 justify-between">
          ...
          <div className="w-[700px] h-[450px] rounded-lg bg-[#141414] overflow-hidden flex flex-col mb-10 justify-between">
            ...
            <div className="p-2 text-3xl font-medium">
              <div className="mx-2">
                <h2>Thumper</h2>
                <p className="text-sm">
                  An app to keep track of events you are interested in and
                  review events you have been to.
                </p>
              </div>
              <a
